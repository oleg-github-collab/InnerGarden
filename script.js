...
const translations = {
    uk: {
        ...
        'timeline-veterans-title': 'Лекція про програми відновлення',
        ...
        'artist-bio-1': 'Марина Камінська - українська візуальна художниця, відома своїми динамічними та плавними абстрактними роботами в акрилі та акварелі. Її картини часто містять переплетені людські фігури, вловлені в плавних, природних формах.',
        'artist-bio-2': 'Випускниця Національної академії образотворчого мистецтва та культури в Києві, Марина також має ступінь магістра Університету фізичного виховання та спорту України. На кафедрі біомеханіки вона заглибилася в хатха-йогу, розглядаючи її як екзистенційну та дослідницьку систему, яка сприяє творчості, самосвідомості та глибшому розумінню світу.',
        ...
        'phys1-desc': 'Оригінальна акварель на папері, 70x100 см',
        'phys2-desc': 'Акрил на полотні, 100x120 см',
        'phys3-desc': 'Змішана техніка, 80x100 см',
        'phys4-desc': 'Акрил на полотні, 90x110 см',
    ...
    en: {
        ...
        'timeline-veterans-title': 'Lecture on Recovery Programs',
        ...
        'phys1-desc': 'Original watercolor on paper, 70x100 cm',
        'phys2-desc': 'Acrylic on canvas, 100x120 cm',
        'phys3-desc': 'Mixed media, 80x100 cm',
        'phys4-desc': 'Acrylic on canvas, 90x110 cm',
        'nft1-title': 'Sacred Dance NFT',
        'nft2-title': 'Soul Expression NFT',
        'nft3-title': 'Eternal Movement NFT',
        'nft4-title': 'Inner Harmony NFT',
    ...
    de: {
        ...
        'timeline-veterans-title': 'Vortrag über Rehabilitationsprogramme',
        ...
        'phys1-desc': 'Original Aquarell auf Papier, 70x100 cm',
        'phys2-desc': 'Acryl auf Leinwand, 100x120 cm',
        'phys3-desc': 'Mischtechnik, 80x100 cm',
        'phys4-desc': 'Acryl auf Leinwand, 90x110 cm',
        'nft1-title': 'Sacred Dance NFT',
        'nft2-title': 'Soul Expression NFT',
        'nft3-title': 'Eternal Movement NFT',
        'nft4-title': 'Inner Harmony NFT',
    ...
    es: {
        ...
        'phys1-desc': 'Acuarela original sobre papel, 70x100 cm',
        'phys2-desc': 'Acrílico sobre lienzo, 100x120 cm',
        'phys3-desc': 'Técnica mixta, 80x100 cm',
        'phys4-desc': 'Acrílico sobre lienzo, 90x110 cm',
        'nft1-title': 'Sacred Dance NFT',
        'nft2-title': 'Soul Expression NFT',
        'nft3-title': 'Eternal Movement NFT',
        'nft4-title': 'Inner Harmony NFT',
...
const artworks = [
    { id: 1, title: 'Flow of Consciousness', description: 'Watercolor on paper', size: '70x100 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772927/10_xtez6l.jpg', year: '2024' },
    { id: 2, title: 'Inner Harmony', description: 'Acrylic on canvas', size: '80x100 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772909/8_yoldq6.jpg', year: '2024' },
    { id: 3, title: 'Eternal Movement', description: 'Watercolor on paper', size: '60x80 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772895/9_wibtjv.jpg', year: '2024' },
    { id: 4, title: 'Soul Expression', description: 'Acrylic on canvas', size: '100x120 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772891/25_mkcl0g.jpg', year: '2024' },
    { id: 5, title: 'Vibrations', description: 'Watercolor on paper', size: '50x70 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772876/37_qkiv50.jpg', year: '2024' },
    { id: 6, title: 'In My Inner Garden', description: 'Mixed media', size: '90x110 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772827/24_k2msrg.jpg', year: '2024' },
    { id: 7, title: 'Sacred Dance', description: 'Acrylic on canvas', size: '60x80 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1752772734/21_fu1bko.jpg', year: '2024' },
    { id: 8, title: 'Unity', description: 'Watercolor on paper', size: '80x100 cm', image: 'https://res.cloudinary.com/djdc6wcpg/image/upload/v1745600732/wrlsd9dywof5hk44mcxn.jpg', year: '2024' }
];
